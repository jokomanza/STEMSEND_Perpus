 ...
 * @author Luciver
 */
public class formBayarDendaSudahDibayar extends javax.swing.JDialog {
     ...
     * @param id
     */
    public formBayarDendaSudahDibayar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        tampilTblDenda();
        isiComboBox();
    ...
    private void tampilTblDenda() {
        ...
        try {
            sql = "select \n"
                    ...
                    + "	from tblPeminjaman \n"
                    + "where tanggalHaruskembali < (Select now()) and status ='Bayar Denda' order by idPeminjaman asc;";
    ...
    private void isiComboBox() {
        ...
        try {
            sql = "select idPeminjaman from tblPeminjaman where tanggalHaruskembali < (Select now()) and status ='Bayar Denda'";
            stat = con.createStatement();
            result = stat.executeQuery(sql);
            if (result.next()) {
                while (result.next()) {
    ...
    private void initComponents() {
        ...
        btnOk.setText("Batal Bayar Denda");
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        if (cmbIdPeminjaman.getSelectedItem() != "Kosong") {
            try {
                String sql = "update tblPeminjaman set status = 'DiPinjam' where idPeminjaman = " + cmbIdPeminjaman.getSelectedItem() + "";
...
//        ganti(id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formBayarDendaSudahDibayar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                formBayarDendaSudahDibayar dialog = new formBayarDendaSudahDibayar(new javax.swing.JFrame(), true);
