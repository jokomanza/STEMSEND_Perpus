 ...
 * @author Luciver
 */
public class formDetailDenda extends javax.swing.JDialog {
     ...
     * @param id
     */
    public formDetailDenda(java.awt.Frame parent, boolean modal, String id) {
        super(parent, modal);
        initComponents();
        tampilTblDenda();
        isiComboBox(id);
    ...
    private void isiComboBox(String id) {
    ...
    private void initComponents() {
        ...
        txtDendaPerHari.setText("Rp. 500,00 Perhari");
        ...
        jLabel10.setText("Detail Denda Siswa");
...
//        ganti(id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formDetailDenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                formDetailDenda dialog = new formDetailDenda(new javax.swing.JFrame(), true, "8");
